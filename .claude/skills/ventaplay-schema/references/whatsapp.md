...
**Tipos de evento soportados** (14 eventos, al 2026-05-29):
...
⭐ = `oportunidad_cambio_estado` + `formulario_enviado` agregados 2026-05-27; `cita_agendada_widget` agregado 2026-05-29 (mig `20260618120000`).
