...
export default function LoginForm({ initialData, onSubmit }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      await onSubmit({ email, password, months, bookingType });
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className="mb-1" dangerouslySetInnerHTML={{ __html: LOGO_SVG }} />

      <h1 className="text-lg font-semibold text-white/90 -mt-2">
        Extractor de Reservas
      </h1>
      ...
      <fieldset className="w-full">
        ...
        <div className="flex flex-col gap-2">
          <RadioOption
            ...
            label="Obtener todas — reservadas + bloqueadas"
          />
          <RadioOption
            name="bookingType"
            value="reserved"
      ...
      >
        {submitting ? "Seleccionar carpeta..." : "Iniciar Extracción"}
      </button>
    </form>
  );
}
